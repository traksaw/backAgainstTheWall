      ...
      <section className="bg-white text-black">
        ...
        <div className="block md:hidden px-6 py-8">
          <div className="text-center space-y-6">
            ...
            <FadeInScale delay={1200} duration={600}>
              <div className="pt-4">
                {user ? (
                  latestResult?.hasWatchedFilm ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <Button
                          onClick={onWatchFilm}
                          className="bg-[#B95D38] hover:bg-[#B95D38]/90 text-white w-full py-3 rounded-full font-medium transform hover:scale-105 transition-all duration-300"
                        >
                          Watch Again
                        </Button>
                    ...
                    <div className="space-y-4">
                      <Button
                        onClick={onStartQuiz}
                        className="bg-[#B95D38] hover:bg-[#B95D38]/90 text-white w-full py-3 rounded-full font-medium text-base transform hover:scale-105 transition-all duration-300"
                      >
                        Take the quiz & Watch the film
                      </Button>
                      <button
                        onClick={onWatchFilm}
                        className="text-sm text-[#B95D38] hover:underline block w-full transition-all duration-300 hover:text-[#B95D38]/80"
                      >
        ...
        {/* Desktop Content - Original Design with Animations */}
        <div className="hidden md:block py-20 px-6 text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <FadeInUp delay={1100} duration={800}>
            ...
            <FadeInScale delay={1400} duration={600}>
              {user ? (
                latestResult?.hasWatchedFilm ? (
                  <div className="flex flex-col items-center gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      ...
                      <Button
                        onClick={onWatchFilm}
                        className="bg-[#B95D38] hover:bg-[#B95D38]/90 text-white transform hover:scale-105 transition-all duration-300"
                      >
                        Watch Again
                      </Button>
                      <Button
                  ...
                  <div className="flex flex-col items-center gap-6">
                    <Button
                      onClick={onStartQuiz}
                      className="bg-[#B95D38] hover:bg-[#B95D38]/90 text-white text-lg px-8 py-4 rounded-full transition-all duration-300 shadow-md transform hover:scale-105"
                    >
                      Take the quiz & Watch the film
                    </Button>
                    <button
                      onClick={onWatchFilm}
                      className="text-sm text-[#B95D38] hover:underline transition-all duration-300 hover:text-[#B95D38]/80"
                    >
                      Watch the film without taking the quiz →
                    </button>
                  </div>
